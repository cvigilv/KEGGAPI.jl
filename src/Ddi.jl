"""
    ...
    kegg_ddi(dbentries::Vector{String}; [timeout::Float64 = 0.4]) -> KeggTupleList
...
# Returns
- `KeggTupleList`: Rows with `Entry 1`, `Entry 2`, `Interaction Type`, and
  `Mechanism` fields. The interaction type is `CI` (contraindication) or `P`
  (precaution).
